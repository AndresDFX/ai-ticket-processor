  ...
  const tourSteps: TourStep[] = [
    {
      ...
      description:
        'Aquí verás los tickets procesados en tiempo real y su estado de clasificación.',
    },
    {
      title: 'Crea tickets en segundos',
      description:
        'Usa el formulario para registrar un nuevo ticket y verlo aparecer al instante.',
    },
    {
      title: 'Filtra y navega',
      description:
        'Busca por descripción o categoría y revisa los tickets por páginas.',
    },
  ];
